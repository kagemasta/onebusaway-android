...
public class MyRecentAlertActivity extends Activity {
    //
    // The only thing this is used for anymore is to create
    // a shortcut to the recent alert list.
    //
    @Override
    ...
    private Intent getShortcutIntent() {
        final Uri uri = MyTabActivityBase.getDefaultTabUri(MyRecentAlertFragment.TAB_NAME);
        return UIHelp.makeShortcut(this,
                    getString(R.string.recent_routes_shortcut),
                    new Intent(this, AlertActivity.class)
                        .setData(uri));
    }
}
